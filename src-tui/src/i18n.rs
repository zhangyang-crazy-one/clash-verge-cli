...
fn english(key: &'static str) -> &'static str {
    match key {
        ...
        "hint.proxies" => "Enter group/node | t delay | T all | c chain",
        ...
        "proxies.hint_normal" => "Enter group/node | t | T | c",
...
fn chinese(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "hint.proxies" => "Enter 选择组/节点 | t 延迟 | T 全部 | c 链式代理",
        ...
        "proxies.hint_normal" => "Enter 组/节点 | t | T | c",
