...
fn english(key: &'static str) -> &'static str {
    match key {
        ...
        "settings.writable_hint" => "Enter toggles the highlighted setting. TUN restart reloads the core.",
        ...
        "settings.tun_on" => "TUN enabled (core restarting)",
        "settings.tun_off" => "TUN disabled (core restarting)",
...
fn chinese(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "settings.writable_hint" => "Enter 切换高亮项。开启/关闭 TUN 会重启内核。",
        ...
        "settings.tun_on" => "已开启 TUN（正在重启内核）",
        "settings.tun_off" => "已关闭 TUN（正在重启内核）",
